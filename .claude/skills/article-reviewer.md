...
description: 수집된 AI 개발자 아티클 및 AI 게임 개발 사례의 품질을 검토하고 필터링하는 패턴. 광고/스팸 제거, 중복 탐지, 실용성 판정, 최종 선별 시 사용.
---

# Article Reviewer — AI 개발자 아티클 + AI 게임 개발 사례 품질 검토 패턴

수집된 아티클 후보에서 저품질·중복·단순 뉴스 기사를 제거하고
개발자에게 실질적으로 유용한 콘텐츠를 선별한다.
AI 게임 개발 사례의 경우, 프로그래머가 직접 하기 어려운 영역(아트, UI, 사운드 등)을
AI로 보완하는 실전 사례를 우선 통과시킨다.
...
`game asset`, `3d model`, `texture`, `sprite`, `voxel`, `character design`,
